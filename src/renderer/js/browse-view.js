...
function uncRoot(dirPath) {
  // Ведущих разделителей может оказаться больше двух: опечатка, двойная
  // вставка, '////srv' из строки ввода. Требовать РОВНО два значило бы снова
  // отправлять такой путь в обычную ветку, где крошка резолвится относительно
  // рабочей папки главного процесса кокпита (M-4 ре-ревью — тот же дефект в
  // третий раз, просто в другой форме записи).
